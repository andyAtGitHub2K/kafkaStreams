 ...
 *
 */
public class TrackTop5HighVolumeWithInterceptors {
    private static Logger logger = LoggerFactory.getLogger(TrackTop5HighVolumeWithInterceptors.class);
    ...
    public static void main(String[] argv) throws IOException, InterruptedException {
        ...
        // [ add interceptors ]
       // appProperties.put(StreamsConfig.producerPrefix(ProducerConfig.INTERCEPTOR_CLASSES_CONFIG),
       //         Collections.singletonList(StockTxProducerInterceptor.class));
        streamProperties.put(StreamsConfig.consumerPrefix(ConsumerConfig.INTERCEPTOR_CLASSES_CONFIG), Collections.singletonList(ahbun.Chapter7.interceptors.StockTxConsumerInterceptor.class));

        // 2. create topology
        KafkaStreams kafkaStreams = new KafkaStreams(getTopology(appProperties), streamProperties);
        // 3. start data generator
        MockDataProducer.produceStockTransaction(10, 5,
