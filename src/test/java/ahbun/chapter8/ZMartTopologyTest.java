...
public class ZMartTopologyTest {
    ...
    public void setup(){
        try {
            ...
            testDriver = new TopologyTestDriver(ZMartTopology.getTopology(kafkaStreamProperties, businessProperties), kafkaStreamProperties);
    ...
    public void testRewardTopic() {
        ...
        for(Purchase expectedPurchase: expectedPurchaseList) {
            ...
            Assert.assertEquals(expectedPurchase.getCustomerId(), resultingReward.getCustumerID());
